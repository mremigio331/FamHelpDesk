...
const GroupMembershipRequestListItem = ({
  request,
  isAdmin,
  isReviewing,
  onApprove,
        ...
        isAdmin
          ? [
              <Popconfirm
                ...
                description={`Are you sure you want to approve ${request.user_display_name || request.user_email}'s membership request?`}
                onConfirm={() =>
                  onApprove(
                    request.user_id,
              ...
              <Popconfirm
                ...
                description={`Are you sure you want to reject ${request.user_display_name || request.user_email}'s membership request?`}
                onConfirm={() =>
                  onReject(
                    request.user_id,
                    request.user_display_name || request.user_email,
...
export default GroupMembershipRequestListItem;
