...
class QueueValidationException(Exception):
    """Base exception for queue validation errors."""

    pass


class InvalidQueueData(QueueValidationException):
    """Exception raised when queue data is invalid."""

    pass


class QueueNameTooLong(QueueValidationException):
...
class QueueDescriptionTooLong(QueueValidationException):
...
class QueueNotFound(QueueValidationException):
    """Exception raised when queue is not found."""

    pass


class QueueGroupMismatch(QueueValidationException):
...
class QueueValidationHelper:
    ...
    def validate_family_exists(self, family_id: str) -> None:
        ...
        if not family:
            raise InvalidQueueData(f"Family with ID {family_id} not found.")
